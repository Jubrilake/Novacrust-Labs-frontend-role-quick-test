...
export function ComingSoon({
  ...
  const handleSubmit = () => {
    ...
    alert(
      `Thank you! We'll notify you at ${email} when ${featureName} is available.`
    );
    setEmail("");
  };
      ...
      <div className="flex flex-col items-center justify-center py-16 px-4">
        ...
        <div className="w-full max-w-md space-y-4">
          ...
          <Button
            ...
            className="w-full h-14 bg-primary rounded-full hover:bg-primary/90 text-white text-base font-medium"
          >
            Update me
          </Button>
        </div>
