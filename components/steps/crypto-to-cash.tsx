        ...
        <div className="bg-transparent rounded-2xl p-4 border border-gray-200">
          ...
          <div className="flex items-center justify-between mt-2">
            <Input
              ...
              className="border-0 w-20 bg-transparent shadow-none lg:text-2xl text-xl font-semibold p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0"
              placeholder="0.00"
            />
            <CurrencySelector
        ...
        <div className="bg-transparent rounded-2xl p-4 border border-gray-200">
          ...
          <div className="flex items-center justify-between mt-2">
            <Input
              ...
              className="border-0 w-20 bg-transparent lg:text-2xl text-xl shadow-none font-semibold p-0 h-auto focus-visible:ring-0 focus-visible:ring-offset-0"
              placeholder="0.00"
            />
            <CurrencySelector
